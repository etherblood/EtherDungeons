...
public class ModelSkin {
    ...
    public ModelSkin(MaterialFactory materialFactory, String fileResourcePath) {
        ...
        this.fileResourceURL = Objects.requireNonNull(Util.getResourceURL(fileResourcePath), fileResourcePath + " not found");
        loadFile();
    }
    ...
    private final LinkedList<ModelModifier> modelModifiers = new LinkedList<>();
    ...
    private void loadFile() {
        try {
            ...
            throw new RuntimeException("Error while loading object skin '" + fileResourceURL + "'", ex);
        }
    }
...
//                    }
                ...
                if (material != null) {
                    ...
                    try {
                        ...
                        throw new RuntimeException("Error while reading material for object '" + name + "'", ex);
                    }
                }
            }
        }
